      ...
      try {
        ...
        if(response.data) {
          ...
          if(appState.user.username != response.data.author.username) {
            appDispatch({type: "flashMessage", value: "You do not have permmission to edit that post!"});
  ...
  return (
    <Page title="Edit Post">
      ...
      <form className="mt-3" onSubmit={submitHandler}>
        ...
        <button disabled={state.isSaving} className="btn btn-primary">Save Updates
        </button>
      </form>
    </Page>
  );
